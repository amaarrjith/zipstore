...
include('config.php');
$sql = "INSERT INTO `tbl_product`(`category_id`, `subcategory_id`, `product_name`,`product_image`,`product_description`,`stock`,`rate`,`status`) 
VALUES ('$category_id','$subcategory_id','$product_name','$product_images','$product_des','$product_stock','$product_rate','$product_status')";
