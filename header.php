    ...
    <div class="container-fluid">
        ...
        <div class="row align-items-center py-3 px-xl-5">
            ...
            <div class="col-lg-3 col-6 text-right">
                <a href="guest/login.php" class="btn border">
                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu rounded-0 m-0">
                                    <a href="guest/login.php" class="dropdown-item">Shopping Cart</a>
                                    <a href="guest/login.php" class="dropdown-item">Checkout</a>
                                </div>
                            </div>
                        ...
                        <div class="navbar-nav ml-auto py-0">
                            ...
                            <a href="guest/signup.php" class="nav-item nav-link">Register</a>
                        </div>
                    </div>
                </nav>
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                                ...
                                <div class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu rounded-0 m-0">
                                        ...
                                        while ($row = mysqli_fetch_array($res)) {
                                            ?>
                                            <a href="guest/viewproduct.php?clickid=<?php echo $row['subcategory_id']?>" class="dropdown-item"><?php echo $row['subcategory_name'] ?></a>
                                        <?php
                                        }
                                        ?>
                                    </div>
