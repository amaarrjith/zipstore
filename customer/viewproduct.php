...
<div id="header-carousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="container-fluid pt-5">
            <div class="text-center mb-4">
                ...
                ?>
                <h2 class="section-title px-5 text-uppercase"><span class="px-2"><?php echo $subcat?></span></h2>
            </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                    <div class="card product-item border-0 mb-4">
                        <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                            <img class="img-fluid w-100" src="../admin/images/<?php echo $display ["product_image"]?>" style="height: 35ex;">
                        </div>
                        ...
                        <div class="card-footer d-flex justify-content-between bg-light border">
                            ...
                            <a href="cart_action.php?viewid=<?php echo $display ["product_id"]?>&rate=<?php echo $display ["rate"]?>" class="btn btn-sm text-dark p-0"><i class="fas fa-shopping-cart text-primary mr-1"></i>Add To Cart</a>
                        </div>
                    </div>
                </div>
                <?php
