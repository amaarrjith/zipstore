...
$sql = "INSERT INTO `tbl_payment`(`bill_id`,`payment_date`, `card_no`, `total_amount`)
VALUES ('$billid','$payment_date','$card_no','$total')";
$result = mysqli_query($conn,$sql);
...
$sql5 = "UPDATE tbl_shipping SET bill_id = '$billid' WHERE customer_id = '$customer_id'"; // Removed backticks and corrected table name
$res4 = mysqli_query($conn, $sql5);

$sql6 = "UPDATE tbl_billing SET bill_id = '$billid' WHERE customer_id = '$customer_id'"; // Removed backticks and corrected table name
