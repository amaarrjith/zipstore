...
<head>
    ...
    <link href="stylepay.css" rel = "stylesheet">
</head>
                        ...
                        <div class="tab-content">
                            ...
                            <div id="menu2" class="tab-pane in active">
                                <div class="row justify-content-center">
                                    <div class="col-11">
                                        <div class="form-card">
                                            <h3 class="mt-0 mb-4 text-center text-uppercase">Enter your card details to pay</h3>
                                            <form action="payment_action.php" method="post">
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="input-group"> <input type="text" name= "card" id="cr_no" placeholder="0000 0000 0000 0000" minlength="16" maxlength="16"> <label>CARD NUMBER</label> </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-6">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12"> <input type="submit" value="Pay <?php echo $total_amount ?>" class="btn btn-success placeicon"> </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-12"> <a href = "cancel_action.php"><input value="Cancel Transaction" class="btn btn-danger placeicon p-3"></a> </div>
                                                </div>
                                                <input name="amount" type="hidden" value = "<?php echo $total_amount?>">
                                            </form>
                                        </div>
                                    </div>
                                </div>
