        ...
        <div class="row px-xl-5">
            ...
            <div class="col-lg-7 pb-5">
                ...
                <div class="d-flex align-items-center mb-4 pt-2">
                    ...
                    <a href="cart_action.php?viewid=<?php echo $display["product_id"] ?> &rate=<?php echo $display["rate"] ?>">
                ...
                <a href="buy.php?viewid=<?php echo $display["product_id"] ?> &rate=<?php echo $display["rate"] ?>">
                    <button class="btn btn-primary px-3">
