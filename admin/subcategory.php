                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Sub Category Register Form</h6>
                            ...
                            <form action = "subcategory_action.php" method="post" enctype = "multipart/form-data">
                                ...
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Sub Category Photo</label>
                                    <input type="file" class="form-control" name="subcategory_img" id="exampleInputEmail1"
                                        aria-describedby="emailHelp">
